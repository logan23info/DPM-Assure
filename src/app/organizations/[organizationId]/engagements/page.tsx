...
export default async function EngagementsPage({ params }: PageProps) {
  ...
  const engagements = await authorizeTenantTransaction({ principal: current.principal, organizationId, requestId: crypto.randomUUID(), permission: permissions.engagementRead }, listEngagements);
